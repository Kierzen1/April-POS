...
// Validate ../../../src/app/waiting-activation/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/waiting-activation">> = Specific
  const handler = {} as typeof import("../../../src/app/waiting-activation/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
